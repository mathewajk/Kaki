...
function Login( { lang } ) {
  ...
  return (
    <div className="flex text-base md:text-lg lg:text-xl h-full justify-center items-center font-mplus">
        ...
        <div className="mb-5 text-center items-center"><button onClick={() => signIn('google', { callbackUrl: 'http://localhost:3000' })}>{lang === "EN"? "Log in with Google" : "Googleでログインする"}</button></div>
