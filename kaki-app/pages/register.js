  ...
  return (
    <>
        ...
        <div className="flex text-base md:text-lg lg:text-xl h-full justify-center items-center font-mplus">
            <div className="flex text-2xl pr-10 mr-10 border-r h-1/2 justify-center items-center border-gray-800 "><div>{lang === "EN"? "Register for Kaki" : "アカウントを登録する"}</div></div>
            ...
            <button type="submit" className="kaki-button mt-2 w-full leading-tight shadow-md" onClick={handleRegistration}>{lang === "EN"? "Register" : "登録"}</button> 
       </form>
